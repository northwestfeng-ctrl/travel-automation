#!/usr/bin/env python3
"""
Canonical source for the IM session extraction script.
"""
from __future__ import annotations


EXTRACT_SESSIONS_JS_CONTENT = """// 携程ebooking IM 会话列表提取 - 基于实测DOM结构
...
def write_extract_sessions_file(path: str) -> None:
    with open(path, "w", encoding="utf-8") as f:
        f.write(EXTRACT_SESSIONS_JS_CONTENT)
